...
import 'package:shared_preferences/shared_preferences.dart'; // <--- تأكدي من هذا الاستيراد
import '../../domain/product.dart';
import '../models/product_model.dart';

class BirthdayRemoteDataSource {
  final http.Client client;
  BirthdayRemoteDataSource({required this.client});

  Future<List<ProductModel>> fetchProductsByCategory(String categoryId, {String? type}) async {
    print('Fetching products for category: $categoryId with type: ${type ?? "Birthday"}');
