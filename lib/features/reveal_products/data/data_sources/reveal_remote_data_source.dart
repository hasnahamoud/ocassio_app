...
import 'package:ocassio_app/features/reveal_products/data/models/product_model.dart';
import 'package:shared_preferences/shared_preferences.dart';

class RevealRemoteDataSource {
  final http.Client client;
  RevealRemoteDataSource({required this.client});

  Future<List<ProductModel>> fetchProductsByCategory(String categoryId, {String? type}) async {
    print('Fetching products for category: $categoryId with type: ${type ?? "Reveal"}');
