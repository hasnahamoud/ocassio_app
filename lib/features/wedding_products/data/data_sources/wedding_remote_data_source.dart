...
import 'package:ocassio_app/features/wedding_products/data/models/product_model.dart';
import 'package:shared_preferences/shared_preferences.dart';

class WeddingRemoteDataSource {
  final http.Client client;
  WeddingRemoteDataSource({required this.client});

  Future<List<ProductModel>> fetchProductsByCategory(String categoryId, {String? type}) async {
    print('Fetching products for category: $categoryId with type: ${type ?? "Wedding"}');
    ...
    try {
      ...
      final String authToken = 'Bearer $storedToken';
