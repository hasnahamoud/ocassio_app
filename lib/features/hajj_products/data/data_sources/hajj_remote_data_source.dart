...
import '../../../hajj_products/data/models/product_model.dart';

class HajjRemoteDataSource {
  final http.Client client;
  HajjRemoteDataSource({required this.client});

  Future<List<ProductModel>> fetchProductsByCategory(String categoryId, {String? type}) async {
    print('Fetching products for category: $categoryId with type: ${type ?? "Al-Hajj"}');
